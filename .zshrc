...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(load status history time)
...
export PATH="/usr/local/sbin:/opt/local/bin:/opt/local/sbin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/opt/X11/bin"
...
export TMUX_POWERLINE_SEG_WEATHER_LOCATION="968019"
